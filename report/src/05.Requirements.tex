...
According to the Gantt chart (Table~\ref{gantt}) the team were supposed to update the
...
\caption{Non-Functional requirement for speed} \label{table:nfSpeed} \\
...
\subsubsection{Size}
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Non-Functional requirement for size} \label{table:nfSize} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Value}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Non-Functional requirement for ease of Use} \label{table:nfEase} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Value}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Non-Functional requirement for reliability} \label{table:nfReliability} \\
\hline
...
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Non-Functional requirement for robustness} \label{table:nfRobustness} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Value}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Non-Functional requirement for portability/scalability} \label{table:nfPortScale} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Value}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\subsubsection{Other Non-Functional}
\begin{longtable}{|l|p{5cm}|p{1.8cm}|l|p{4.4cm}|}
\caption{Other non-functional} \label{table:nfOther} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Value}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\begin{longtable}{|l|p{7cm}|l|p{5cm}|}
\caption{Security requirements for auditing} 
\label{table:nfaud} \\
\hline \multicolumn{1}{|c|}{\textbf{ID}} &
\multicolumn{1}{c|}{\textbf{Measure}} &
\multicolumn{1}{c|}{\textbf{Priority}} &
...
\caption{Requirements not met}\label{table:reqNotMet} \\
\hline {\textbf{ID}} &
{\textbf{Requirement}} \\ 
\hline 
FJ-09 & A judge shall get a notification when received a question \\\hline
FF-01 &A functionary shall be able to register a balloon colour to each task/problem \\\hline
FO-02 & The system shall be able to gather a large variety of statistic specified by
the admin \\\hline
\end{longtable}
\end{center}
...
\begin{longtable}{|l|l|}
    \caption{Requirements partially met}\label{table:reqPartMet} \\
    \hline {\textbf{ID}} &
    {\textbf{Requirement}} \\ 
    \hline 
    FA-10 & An admin can add a node \\
    \hline
    FA-11 & An admin can remove a node \\
    \hline
    FA-12 & An admin can manage a node\\
    \hline
    NF-01 & Response from action\\
    \hline
    NR-03 & Logs will be backed up \\
    \hline
\end{longtable}
