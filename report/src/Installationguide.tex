...
{\textquoteleft}gentledb'@'localhost'
IDENTIFIED BY {\textquoteleft}password';
...
Remember to replace {\textquoteleft}gentledb' and
{\textquoteleft}password' with a suitable username and
password. \newline
