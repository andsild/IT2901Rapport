...
{\textless}any notes{\textgreater}}\\\hline
...
\begin{center}
\tablehead{\hline
\multicolumn{1}{|m{0.5\textwidth}|}{Sprint: 0} &
...
\begin{center}
\tablehead{\hline
\multicolumn{1}{|m{0.5\textwidth}|}{Sprint: 0-a } &
Working towards: M-01\\\hline}
\begin{supertabular}{|m{0.5\textwidth}m{0.5\textwidth}|}
\multicolumn{2}{|m{\textwidth}|}{Overview over packages to be
completed:
...
administrative tasks. This sprint marked the end of that phase. We
moved on to actual implementing. However, we ere not familiar with the
tools and frameworks available to us, and as a consequence we decided
to use this sprint to get everyone up to date on Django//python. We had
a coding night this sprint. Working all members together. }\\\hline
\end{supertabular}
\end{center}
\clearpage
...
\begin{itemize}
	\item This sprint we had a meeting with the supervisor discussing the
		  activity diagrams. Show suggested that we switch them with our
\end{itemize}
}\\\hline
\multicolumn{2}{|m{\textwidth}|}{Packages completed:

\begin{itemize}
	\item Sponsor support
	\item Testplan
\end{itemize}
~
...
completed. We was happy with the resut. We also finished the mid-term
in food time before the actual deliver. }\\\hline
\end{supertabular}
\end{center}
\clearpage
...
\begin{itemize}
	\item We must be better to work with other group members code.
\end{itemize}
~
...
making our Firs release. Unfortunately we did not have time to set up
...
After we put the solution up, there was sum bugs and testing to be done.
...
were, however happy with our peer evaliation. }\\\hline
\end{supertabular}
\end{center}
\clearpage
...
\begin{itemize}
	...
	\item judge contest acsess 
\end{itemize}
~
}\\\hline
\multicolumn{2}{|m{\textwidth}|}{Summary:

Are last sprint before the final event consisted mainly on small
...
\begin{itemize}
	\item Effiency and communication is import this last period
\end{itemize}
~
}\\\hline
\multicolumn{2}{|m{\textwidth}|}{Notes:
