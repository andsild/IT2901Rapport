...
disagreement. The gr\oup elected Haakon to be scrum master because of
...
the rest of the gr\oup. This includes meetings with the customer and
...
requested to say three go\od things and three bad things regarding the
...
members of the gr\oup, before setting up the next sprint. Scrum also
focuses on having finished versions of the systems on each iteration,
and to finish all packages in the gi\ven iteration.
...
gantt chart is shown in figure 3.2.
\begin{tabular}{|m|m|m|m|m|m|m|m|m|m|m|m|m|m|m|m|}
\hline
