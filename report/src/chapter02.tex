...
\begin{tabularx}{\textwidth}{|X|X|}
\hline
 \includegraphics[width=0.7035in,height=0.698in]{figure/chapter02-img1.jpg}  &
Use case actor. Represents a user group\\\hline
 \includegraphics[width=0.4535in,height=0.9138in]{figure/chapter02-img2.png}  &
...
were trying to accomplish.
 ...
 \includegraphics[width=5.8339in,height=9.5366in]{figure/chapter02-img3.jpg} %
...
%ingen giddet å se over og kommentere?
 ...
 \includegraphics[width=4.9272in,height=6.9374in]{figure/chapter02-img4.jpg} 
